...
<div class="main">
  <div class="hipsum">
    ...
    <div class="container-fluid">
        <div class="col-lg-12 col-md-12 col-sm-12" style="overflow-x: auto;">
            <h1 class="text-warning text-center">Members Registered for Event</h1>
  ...
  <?php
          ...
          $q="SELECT * FROM `eventregistration`";
  ...
  ?>
              <tr class="text-center">
                ...
                <td><button class="btn btn-danger"> <a href="removeevent.php?id=<?php echo $result['id']; ?>" class="text-white">Remove</a></button></td>
              </tr>
              <?php
          }
              ?>
