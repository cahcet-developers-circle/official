...
<tr>
	...
	<td>
		...
		Present <input required type="radio" name="attendance[<?php echo $show['mem_id'] ?>]" value="Present">Absent <input required type="radio" name="attendance[<?php echo $show['mem_id']; ?>]" value="Absent" type="text">
					...
					if(!$b){
							foreach ($att as $key => $value) {
								...
								if($value=="Present"){
										...
										$query="insert into attendance(value,mem_id,date) values('Present',$key,'$date')";
										$insertResult=$conn->query($query);
											...
											$query="insert into attendance(value,mem_id,date) values('Absent',$key,'$date')";
										$insertResult=$conn->query($query);
